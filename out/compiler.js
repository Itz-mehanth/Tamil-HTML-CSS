...
exports.cssMap = exports.htmlMap = void 0;
exports.loadLocale = loadLocale;
exports.compile = compile;
exports.compileCSS = compileCSS;
const ta_1 = require("./locales/ta");
// Default to Tamil
exports.htmlMap = ta_1.htmlMap;
exports.cssMap = ta_1.cssMap;
function loadLocale(code) {
    try {
        ...
        if (locale && locale.htmlMap && locale.cssMap) {
            exports.htmlMap = locale.htmlMap;
            exports.cssMap = locale.cssMap;
            return;
        }
    }
    catch (e) {
...
function compile(code) {
    ...
    html = html.replace(tagRegex, (match, closeSlash, tagName, attributes, selfClose) => {
        ...
        const translatedTag = exports.htmlMap[tagName] || tagName;
        ...
        if (attributes && attributes.trim().length > 0) {
            ...
            newAttributes = attributes.replace(attrRegex, (attrMatch, attrKey, qVal, sqVal, rawVal) => {
                ...
                const translatedKey = exports.htmlMap[attrKey] || attrKey;
...
function compileCSS(code) {
    ...
    const sortedCss = Object.keys(exports.cssMap).sort((a, b) => b.length - a.length);
    const sortedHtml = Object.keys(exports.htmlMap).sort((a, b) => b.length - a.length);
    ...
    for (const k of sortedCss) {
        ...
        css = css.split(k).join(exports.cssMap[k]);
    }
    // Replace HTML Tags used as Selectors
    for (const k of sortedHtml) {
        css = css.split(k).join(exports.htmlMap[k]);
    }
    // 3. Unmask Strings
